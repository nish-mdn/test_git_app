...
sudo ssh -i /home/travis/build/nish-mdn/test_git_app/blog/mdn-mysql-own.pem -o "StrictHostKeyChecking=no" ubuntu@18.207.183.128
sudo cd blog && rails s -p3000 -d